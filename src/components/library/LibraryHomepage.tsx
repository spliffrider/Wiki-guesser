...
export function LibraryHomepage() {
    ...
    return (
        <div className="library-page w-full">
            <main className="library-container flex flex-col gap-12 font-display min-h-screen">
                {/* Hero Section */}
                    ...
                    <section className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        <div className="lg:col-span-2 bg-[#2a1619] border border-[#482329] rounded-xl p-6 relative overflow-hidden shadow-xl">
                            ...
                            <div className="flex items-center justify-between mb-6">
                                ...
                                <div className="flex items-center gap-3 bg-[#1a0c0e] border border-amber-900/30 px-4 py-2 rounded-lg shadow-inner">
                                    <span className="text-amber-500 font-bold text-xl font-display tracking-wide">Level {level}</span>
                                    <span className="text-2xl filter drop-shadow-md transform hover:scale-110 transition-transform cursor-help" title="Your Scholar Rank">{levelBadge}</span>
                                </div>
                            </div>
